...
function Footer() {
	...
	const footerNavigation = {
		social: [
			{
				name: "WhatsApp",
				href: "https://wa.me/919895297783?text=Hi%2C%20I%27m%20interested%20in%20learning%20Kalaripayattu%20at%20VPS%20Kalari",
				icon: (props) => (
					<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
						<path fill="#25D366" d="M24,4C12.954,4,4,12.954,4,24c0,3.876,1.105,7.49,3.01,10.56L4,44l9.768-2.902C16.693,42.953,20.238,44,24,44c11.046,0,20-8.954,20-20S35.046,4,24,4z"></path>
						<path fill="#FFF" d="M34.354,29.729c-0.479-0.239-2.836-1.398-3.275-1.557c-0.439-0.159-0.759-0.239-1.078,0.239c-0.319,0.479-1.238,1.557-1.517,1.876c-0.279,0.319-0.559,0.359-1.038,0.12c-0.479-0.239-2.023-0.746-3.853-2.378c-1.423-1.271-2.384-2.84-2.663-3.319c-0.279-0.479-0.03-0.738,0.21-0.977c0.216-0.215,0.479-0.559,0.719-0.838c0.239-0.279,0.319-0.479,0.479-0.798c0.159-0.319,0.08-0.599-0.04-0.838c-0.12-0.239-1.078-2.599-1.477-3.558c-0.389-0.934-0.784-0.808-1.078-0.823c-0.279-0.014-0.599-0.017-0.918-0.017c-0.319,0-0.838,0.12-1.277,0.599c-0.439,0.479-1.677,1.638-1.677,3.994c0,2.357,1.717,4.635,1.956,4.954c0.239,0.319,3.378,5.155,8.184,7.229c1.144,0.494,2.037,0.789,2.734,1.01c1.148,0.365,2.194,0.314,3.021,0.19c0.921-0.137,2.836-1.159,3.235-2.278c0.399-1.119,0.399-2.078,0.279-2.278C35.153,30.008,34.834,29.968,34.354,29.729z"></path>
					</svg>
				),
			},
			{
					...
					<div className="grid grid-cols-1 gap-8 mb-12 md:grid-cols-2 lg:grid-cols-3">
						...
						<motion.div
							...
							<div className="space-y-3 text-gray-300">
								<motion.p whileHover={{ x: 3 }} className="transition-all duration-200 flex items-center gap-3 flex-wrap">
									...
									<a
										...
										className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-white bg-green-600 hover:bg-green-500 rounded-full transition-all duration-300 hover:scale-105">
